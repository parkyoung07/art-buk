...
export const TRADITIONAL_MARKETS: TraditionalMarket[] = [
  ...
  },
  {
    ...
    scheduleDays: [2, 7],
    scheduleDescription: "매월 2일 · 7일 5일장 (상설 점포 상시 운영)",
    specialties: ["원조 밀양 돼지국밥 (단골집·동부식당)", "보리밥 골목", "장터 순대", "밀양 대추빵", "얼음골 사과"],
    address: "경상남도 밀양시 상설시장3길 18-16",
    description: "조선시대 성남장터에서 시작되어 500여 년의 역사를 품은 시장으로, 대한민국 돼지국밥의 원조 고향으로 꼽힙니다.",
    tips: "국보 영남루와 밀양아리랑아트센터 전시를 둘러본 뒤 2·7일 장날 백년가게 단골집 돼지국밥을 맛보세요."
  },
  {
