      ...
      JSON.stringify({
        ...
        stats: {
          ...
          topPages: [
            ...
            { path: "/events/busan-biennale-2026", title: "2026 부산비엔날레", count: 32 },
            { path: "/blog", title: "AI 도슨트 전시 블로그", count: 21 },
            { path: "/daangn", title: "당근 이웃 문화 나들이 꿀팁", count: 12 },
            { path: "/events/busan-museum-of-art-modern", title: "부산시립미술관 기획전", count: 9 },
          ],
          weeklyHistory: [
            { date: "09-03", uv: 28, pv: 85 },
            { date: "09-04", uv: 35, pv: 98 },
            { date: "09-05", uv: 48, pv: 140 },
            { date: "09-06", uv: 52, pv: 165 },
            { date: "09-07", uv: 39, pv: 110 },
            { date: "09-08", uv: 45, pv: 132 },
            { date: "09-09", uv: 42, pv: 128 },
          ],
          recentLogs: [
            { time: getKSTTimeString(), path: "/", referrer: "직접 접속 / 북마크", device: "Mobile" },
            { time: "13:15:20", path: "/events/busan-biennale-2026", referrer: "네이버 검색", device: "Desktop" },
            { time: "13:02:11", path: "/blog", referrer: "카카오톡 공유", device: "Mobile" },
            { time: "12:48:50", path: "/", referrer: "당근마켓 피드", device: "Mobile" },
            { time: "12:30:15", path: "/daangn", referrer: "지역 커뮤니티", device: "Desktop" },
          ],
        },
      }),
